package com.bej.authentication.commander.service;
 ...
 public class UserServiceTest {
     ...
     @Test
     public void givenUserLoginSuccessReturnRetrievedUser() throws InvalidCredentialsException {
         when(userRepository.findByEmailAndPassword(any(),any())).thenReturn(user);
